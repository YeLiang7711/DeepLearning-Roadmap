...
### 1.1 线性代数
- 📂 [[../01-数学基础/1.1-线性代数/0-概述-线性代数|概述]] — 全章速查表与推荐阅读顺序
...
### 1.2 微积分
- 📂 [[../01-数学基础/1.2-微积分/0-概述-微积分|概述]] — 全章概览与阅读顺序
...
### 1.3 概率统计
- 📂 [[../01-数学基础/1.3-概率统计/0-概述-概率统计|概述]] — 全章概览与阅读顺序
...
### 1.4 优化
- 📂 [[../01-数学基础/1.4-优化/0-概述-优化|概述]] — 全章概览与阅读顺序
...
### 1.5 信息论
- 📂 [[../01-数学基础/1.5-信息论/0-概述-信息论|概述]] — 全章概览与阅读顺序
...
- 📂 [[../02-Python与PyTorch/2.1-Python科学计算与数据工具/0-概述-Python科学计算与数据工具|概述]] — 全节概览与阅读顺序
- 📄 [[../02-Python与PyTorch/2.1-Python科学计算与数据工具/2.1.1 Python语法、函数、类、迭代器与上下文管理器|2.1.1 Python 语言基础]] — 语法/容器/函数/类/生成器/with
- 📄 [[../02-Python与PyTorch/2.1-Python科学计算与数据工具/2.1.2 类型标注、异常处理与日志|2.1.2 类型标注与日志]] — typing、try/except、logging
- 📄 [[../02-Python与PyTorch/2.1-Python科学计算与数据工具/2.1.3 NumPy数组、广播、索引与向量化|2.1.3 NumPy]] — 数组/广播/索引/向量化
- 📄 [[../02-Python与PyTorch/2.1-Python科学计算与数据工具/2.1.4 SciPy滤波、插值、统计与信号处理|2.1.4 SciPy]] — 滤波/插值/统计/信号处理
- 📄 [[../02-Python与PyTorch/2.1-Python科学计算与数据工具/2.1.5 pandas表格、元数据与实验结果整理|2.1.5 pandas]] — 表格/元数据/实验结果整理
- 📄 [[../02-Python与PyTorch/2.1-Python科学计算与数据工具/2.1.6 Matplotlib与Seaborn可视化|2.1.6 可视化]] — 折线/热图/直方图/箱线图
- 📄 [[../02-Python与PyTorch/2.1-Python科学计算与数据工具/2.1.7 scikit-learn统计学习与指标|2.1.7 scikit-learn]] — PCA/聚类/SVM/指标/异常基线
- 📄 [[../02-Python与PyTorch/2.1-Python科学计算与数据工具/2.1.8 经典机器学习模型SVM与聚类|2.1.8 经典机器学习]] — SVM、KMeans、DBSCAN
- 📄 [[../02-Python与PyTorch/2.1-Python科学计算与数据工具/2.1.9 OpenCV图像处理|2.1.9 OpenCV]] — 对齐/滤波/形态学/连通域
- 📄 [[../02-Python与PyTorch/2.1-Python科学计算与数据工具/2.1.10 配置、命令行、随机种子与目录规范|2.1.10 工程规范]] — 配置/YAML/argparse/种子/目录
- 📄 [[../02-Python与PyTorch/2.1-Python科学计算与数据工具/2.1.11 Git基础、环境管理与依赖锁定|2.1.11 Git 与环境]] — Git/conda/依赖锁定

### 2.2 PyTorch 训练闭环（路线图第 3 章）
- · 2.2.1 Tensor、dtype、shape、device 与自动微分（待编写）
- · 2.2.2 Dataset、DataLoader、采样器与批处理（待编写）
- · 2.2.3 nn.Module、参数、缓冲区、训练/评估模式（待编写）
- · 2.2.4 损失函数、优化器、学习率调度器（待编写）
- · 2.2.5 训练循环、梯度清零、反向传播与梯度裁剪（待编写）
- · 2.2.6 checkpoint、断点续训和推理模式（待编写）
- · 2.2.7 GPU、显存、混合精度、性能分析（待编写）
- · 2.2.8 Hook 与中间特征提取（待编写）
- · 2.2.9 单元测试、shape 测试与数值稳定性（待编写）
